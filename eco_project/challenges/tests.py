...
class ChallengesAPITests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        # 1 day interval, 2 points for a question, 1 point for reaching a feature.
    ...
    def test_submit_answer_api_not_authenticated(self, mock_question_feature: MagicMock) -> None:
        ...
        data = {'answer': 'dummy answer', 'question_id': 1}  # create a dummy answer
    ...
    def test_submit_answer_api_out_of_range(self, mock_question_feature: MagicMock,
        ...
        self.assertEqual(response.data['message'], "You are not in range of the feature")
    ...
    def test_submit_answer_api_already_reached(self, mock_question_feature: MagicMock,
        ...
        data = {'answer': 'dummy answer', 'question_id': 1}  # create the data to send to the api
    ...
    def test_submit_answer_api_correct_answer(self, mock_question_feature: MagicMock,
        ...
        initial_points = self.get_profile().points  # get user initial points so we can check them
        ...
        self.assertIn("correct", response.data['message'])  # check it was a correct answer
    ...
    def test_submit_answer_api_incorrect_answer(self, mock_question_feature: MagicMock,
        ...
        # check that the response contains the correct message and no points awarded
    ...
    def test_nearest_challenges_api_authenticated(self, mock_haversine: MagicMock,
        ...
        @param mock_already_reached: A mock of the user_already_reached_in_window function
        """
        # locally import the FeatureType and FeatureInstance models to avoid circular imports
        from locations.models import FeatureType, FeatureInstance

        # create a dummy feature and two instances of it so we can check the closest one is first
    ...
    def test_create_user_streak_signal(self) -> None:
        ...
        Profile.objects.get_or_create(user=new_user,
                                      defaults={'points': 0, 'latitude': 0.0, 'longitude': 0.0})
